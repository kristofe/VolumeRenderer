...
public:
	...
	GameObject		&operator =  (const GameObject &m) = delete; // C++11 way of preventing method from being generated
	GameObject(const GameObject &m) = delete; // C++11 way of preventing method from being generated
