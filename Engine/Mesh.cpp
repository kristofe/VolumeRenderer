...
void Mesh::DeSerialize(PersistentData& storageData)
{
	...
	mNormals = new Vector3[mNormalCount];
	mColors = new Color[mColorCount];
	mUV = new Vector2[mUVCount];
	mUV2 = new Vector2[mUV2Count];
...
void Mesh::Clone(Mesh& m)
{
	...
	m.mVertices = new Vector3[mVertexCount];
	m.mNormals = new Vector3[mNormalCount];
	m.mColors = new Color[mColorCount];
	m.mUV = new Vector2[mUVCount];
	m.mUV2 = new Vector2[mUV2Count];
...
void Mesh::CopyInVertices(unsigned int vertexCount, Vector3 vertices[]){
...
void Mesh::CopyInNormals(unsigned int normalCount, Vector3 normals[]){
...
void Mesh::CopyInColors(unsigned int ColorCount, Color Colors[]){
	mDirtyFlags |= MESH_STATE_COLORS;
	if(ColorCount != mColorCount){
		SAFE_DELETE_ARRAY(mColors);
...
void Mesh::CopyInUVs(unsigned int uv1Count, Vector2 uv[], unsigned int uv2Count, Vector2 uv2[]){
...
void Mesh::CopyOutVertices(unsigned int& vertexCount, Vector3 vertices[]){
...
void Mesh::CopyOutNormals(unsigned int& normalCount, Vector3 normals[]){
	if(mNormalCount == 0) return;
	normalCount = mNormalCount;
	normals = new Vector3[mNormalCount];
	for(int i = 0; i < mNormalCount; ++i){
...
void Mesh::CopyOutColors(unsigned int& ColorCount, Color Colors[]){
	if(mColorCount == 0) return;
	ColorCount = mColorCount;
...
void Mesh::CopyOutUVs(unsigned int& uv1Count, Vector2 uv[], unsigned int& uv2Count, Vector2 uv2[]){
	if(mUVCount != 0) {
		uv1Count = mUVCount;
		uv = new Vector2[mUVCount];
		for(int i = 0; i < mUVCount; ++i){
			uv[i] = mUV[i];
		}
	}
...
////////////////////////////////////////////////////////////////////////////////
void Mesh::SetVerticesPointer(unsigned int vertexCount, Vector3 vertices[]){
...
////////////////////////////////////////////////////////////////////////////////
void Mesh::SetNormalsPointer(unsigned int normalCount, Vector3 normals[]){
...
////////////////////////////////////////////////////////////////////////////////
void Mesh::SetColorsPointer(unsigned int ColorCount, Color Colors[]){
	mDirtyFlags |= MD_STATE_ColorS;
	SAFE_DELETE_ARRAY(mColors);
	mColorCount = ColorCount;
	mColors = Colors;
}
...
////////////////////////////////////////////////////////////////////////////////
void Mesh::SetUVPointers(unsigned int uv1Count, Vector2 uv[], unsigned int uv2Count, Vector2 uv2[]){
	if(uv != NULL){
...
void Mesh::GetVerticesPointer(unsigned int& vertexCount, Vector3 vertices[]){
	vertexCount = mVertexCount;
	vertices = mVertices;
}

////////////////////////////////////////////////////////////////////////////////
void Mesh::GetNormalsPointer(unsigned int& normalCount, Vector3 normals[]){
	normalCount = mNormalCount;
	normals = mNormals;
}
...
////////////////////////////////////////////////////////////////////////////////
void Mesh::GetColorsPointer(unsigned int& ColorCount, Color Colors[]){
	ColorCount = mColorCount;
	Colors = mColors;
}
...
////////////////////////////////////////////////////////////////////////////////
void Mesh::GetUVPointers(unsigned int& uv1Count, Vector2 uv[], unsigned int& uv2Count, Vector2 uv2[]){
	uv1Count = mUVCount;
	uv = mUV;
...
*/
////////////////////////////////////////////////////////////////////////////////
void Mesh::CopyInUVs(Vector2* uv){
	memcpy(mUV,uv,sizeof(Vector2)*mUVCount);
}
////////////////////////////////////////////////////////////////////////////////
Vector2* Mesh::SwapUVPointer(Vector2* uv){
	Vector2* ret = mUV;
	mUV = uv;
...
////////////////////////////////////////////////////////////////////////////////
Vector2* Mesh::SwapUV2Pointer(Vector2* uv){
	Vector2* ret = mUV2;
	mUV2 = uv;
...
////////////////////////////////////////////////////////////////////////////////
Color* Mesh::SwapColorPointer(Color* c){
	Color* ret = mColors;
	mColors = c;
